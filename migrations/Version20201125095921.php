 ...
 */
final class Version20201125095921 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attribution (id INT AUTO_INCREMENT NOT NULL, computer_id INT NOT NULL, client_id INT NOT NULL, date DATE NOT NULL, time INT NOT NULL, INDEX IDX_C751ED49A426D518 (computer_id), INDEX IDX_C751ED4919EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
